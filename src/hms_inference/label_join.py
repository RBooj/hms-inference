...
from hms_inference.audio_discovery import find_wavs, AUDIO_ROOT_2021
from hms_inference.audio_builder import build_chunk_index
from hms_inference.inspections_loader import load_inspections_2021
...
def attach_inspection_labels_2021(
    ...
    Create segment plan for audio files with build_chunk_index
    ...
    chunks["chunk_start_dt"] = pd.to_datetime(chunks["chunk_start_dt"])
